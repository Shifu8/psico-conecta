  ...
  return (
    <>
      ...
      <form onSubmit={enviar} className="mt-7 space-y-4" noValidate>
        <CampoFormulario etiqueta="Nueva contraseña" type="password" value={password} onChange={(evento) => { setPassword(evento.target.value); setTocado(true); }} error={tocado ? errorPassword : ""} autoComplete="new-password" ayuda={AYUDA_CONTRASENA} minLength={8} maxLength={128} required />
